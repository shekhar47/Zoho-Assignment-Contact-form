    ...
    <div class="container vh-100">
                ...
                <form   method="post" action="save.php">
                    <table class="form-group">
                        <tr>
                            ...
                            <input type="text" name="contact" id="contact" placeholder="contact name"  style="width:500px" class=" flow-control" required>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <input type="email" name="contact" id="contact" placeholder="email"  style="width:500px" class=" flow-control" required>
                            </td>
                        </tr>
                        <tr>
                            <td>
      ...
      <tr>
                        <td style="text-align:center"><br>
                            ...
                            <input type="submit" onclick="save.php" class="btn btn-primary "  style="width:300px" value="save" name="submit">
                        </td>
</tr>
                        
                       <tr>
                           <br>
                       <td style="text-align:center;"> <a href=mycontact.php> <h6>My contacts </h6></a> &nbsp;&nbsp;&nbsp;
                           </td>
                       </tr>
</td>
                    </table>
